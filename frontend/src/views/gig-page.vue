...
<template>
    ...
    <section v-if="gig" class="gig-page main-layout equal-padding">
        <div class="info-side">
            ...
            <carousel-details-cmp :images="images"></carousel-details-cmp>
            <div class="about-gig">
                <p class="about-title" id="aboutThisGig">About This Gig</p>
                <p class="about-text">{{ gig.description }}</p>
            </div>
            <p class="about-title" id="aboutSeller">About The Seller</p>
            <div class="about-seller">
                <div class="seller-profile">
                    <div class="profile-img-about">
                        <img :src="gig.owner.imgUrl" alt="seller image" class="seller-img" />
